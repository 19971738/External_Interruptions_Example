...
# 2 "<built-in>" 2
# 1 "distance_finding.c" 2
# 10 "distance_finding.c"
...
# 13 "distance_finding.c" 2

# 1 "./16x2_LCD_4bit_File.h" 1
# 13 "./16x2_LCD_4bit_File.h"
# 1 "./Configuration_Header_File.h" 1
# 15 "./Configuration_Header_File.h"
#pragma config PLLDIV = 1
#pragma config CPUDIV = OSC1_PLL2
...
#pragma config EBTRB = OFF
# 13 "./16x2_LCD_4bit_File.h" 2
# 25 "./16x2_LCD_4bit_File.h"
...
void main(void)
{
    ...
    Secuence3();
    Secuence4();
    _delay((unsigned long)((900)*(20000000/4000000.0)));
    Distance = (a*1);
    ...
    RB4=1;
     ...
     if(RC0==1 && d == 0){
        ...
        RB0=0;
         ...
         _delay((unsigned long)((300)*(20000000/4000000.0)));
        RC0=0;
        }
    }
    else if(RC1==1 && d==0){
