...
int a = 0;
int cont=1,cont2=0; //VRIABLE PARA INTERRUPCION
void Int_Ext(void); //Interrupciones
...
void main(void)
{
    ...
    TRISA = 0;              //Leds para interrupciones
    //INTCON2bits.RBPU=0;     /*enable PORTB Pull-ups */
    Int_Ext(); //Codigo para interrupciones
    
  
        
    
    //Codigo para las INT Externas
    LCD_Init();
...
void __interrupt() INT_isr(void){//void
    cont++;
    LATA = cont;
    INTCONbits.INT0IF = 0;
